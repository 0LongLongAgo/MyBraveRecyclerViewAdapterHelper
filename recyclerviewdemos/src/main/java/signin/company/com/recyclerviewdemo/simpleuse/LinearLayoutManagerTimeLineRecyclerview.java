...
import signin.company.com.recyclerviewdemo.simpleuse.divider.TimeLineDecoration;

public class LinearLayoutManagerTimeLineRecyclerview extends AppCompatActivity {
    private RecyclerView mRecyclerView;
    private List<String> mDatas;
    private TestAdapter mAdapter;
    public static void newInstance(Context context) {
        context.startActivity(new Intent(context, LinearLayoutManagerTimeLineRecyclerview.class));
    }
    @Override
...
//        mRecyclerView.setLayoutManager(new StaggeredGridLayoutManager(3,StaggeredGridLayoutManager.VERTICAL));
        mRecyclerView.addItemDecoration(new TimeLineDecoration(LinearLayoutManagerTimeLineRecyclerview.this, RoundRectDecoration.VERTICAL_LIST ));
    ...
    class TestAdapter extends RecyclerView.Adapter<TestAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            MyViewHolder holder = new MyViewHolder(LayoutInflater.from(
                    LinearLayoutManagerTimeLineRecyclerview.this).inflate(R.layout.item_text, parent,
                    false));
            return holder;
        }
